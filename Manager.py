...
class Manager:
    ...
    def assign_value(self):
        ...
        self.keyword = self.keyword_input.get().replace(",", ";")
        self.page = self.page_input.get().replace(",", ";")
        self.authority = self.authority_input.get().replace(",", ";")
        self.content = self.content_input.get().replace(",", ";")
